...
const cardData = [
  {
    ...
    description: "Access your saved icons and create custom sets for any project.",
    label: "Collection",
  },
  {
    color: "#060010",
    title: "Limitless Customization",
    description: "Modify colors, sizes, and styles to perfectly match your creative vision.",
    label: "Customization",
  },
  {
    color: "#060010",
  ...
  },
  {
    ...
    description: "Generate icon concepts and designs with our AI assistant.",
    label: "Creativity",
  },
  {
    color: "#060010",
    title: "Optimized Assets",
    description: "Use lightweight icons for faster load times.",
    label: "Performance",
  },
  {
    color: "#060010",
